...
return CMap::mergeArray(
    ...
    array(
        ...
        'params' => array(
            'flex' => array(
                'getPicBatch' => array(
                    'hosts' => ENABLE_MS ? 'http://phototask-task-ms-dev.camera360.com' : 'http://127.0.0.1:8009',
                ),
                'isLike' => array(
                    'hosts' => ENABLE_MS ? 'http://phototask-comment-ms-dev.camera360.com' : 'http://127.0.0.1:8009',
                ),
                'getUinfoByUid' => array(
                    'hosts' => ENABLE_MS ? 'http://phototask-user-ms-dev.camera360.com' : 'http://127.0.0.1:8009',
                ),
                'userNewest' => array(
                    'hosts' => ENABLE_MS ? 'http://phototask-task-ms-dev.camera360.com' : 'http://127.0.0.1:8009',
                ),
